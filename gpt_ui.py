    ...
    with st.spinner("Thinking..."):
        try:
            reply = model.get_recommendations_from_input(
                user_input,
                api_key="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"
            )
...
<div class="dashboard-link">
    ...
    with st.expander("📖 Enrollment Resource Guide", expanded=False):
        st.markdown("""
<div class="dashboard-link">
    <a href="https://indiana-my.sharepoint.com/personal/samarath_iu_edu/Documents/Enrollment%20Guide%20and%20Slide%20Deck%20-%20MSDS.pdf?login_hint=samarath%40iu.edu" target="_blank">📄 Enrollment Guide</a>
</div>
 ...
 <style>
        ...
        <div class='sidebar-footer'>
            <img src="S:\Luddy Hackathon\Project Logo.png" 
                 alt="EduPilot Footer Logo" 
                 style="max-height: 60px;">
        </div>    

    st.markdown("<hr style='margin-top: 25px; margin-bottom: 10px;'>", unsafe_allow_html=True)
    st.image(footer_logo, use_column_width=True)                
